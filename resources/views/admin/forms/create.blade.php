    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.forms.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('form_number') ? 'is-invalid' : '' }}" type="text" name="form_number" id="form_number" value="{{ old('form_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('form_name') ? 'is-invalid' : '' }}" type="text" name="form_name" id="form_name" value="{{ old('form_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('form_format') ? 'is-invalid' : '' }}" name="form_format" id="form_format" required>
                    ...
                    @foreach(App\Models\Form::FORM_FORMAT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('form_format', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
