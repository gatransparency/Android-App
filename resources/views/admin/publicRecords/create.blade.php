...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.publicRecord.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.public-records.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="request_number">{{ trans('cruds.publicRecord.fields.request_number') }}</label>
                <input class="form-control {{ $errors->has('request_number') ? 'is-invalid' : '' }}" type="text" name="request_number" id="request_number" value="{{ old('request_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('response_due') ? 'is-invalid' : '' }}" type="text" name="response_due" id="response_due" value="{{ old('response_due') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('records_requested') ? 'is-invalid' : '' }}" name="records_requested" id="records_requested" required>{{ old('records_requested') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('estimated_amount') ? 'is-invalid' : '' }}" type="number" name="estimated_amount" id="estimated_amount" value="{{ old('estimated_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_paid') ? 'is-invalid' : '' }}" type="number" name="amount_paid" id="amount_paid" value="{{ old('amount_paid', '') }}" step="0.01">
