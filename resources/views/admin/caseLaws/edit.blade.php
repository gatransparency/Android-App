...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.caseLaw.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.case-laws.update", [$caseLaw->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="docket_number">{{ trans('cruds.caseLaw.fields.docket_number') }}</label>
                <input class="form-control {{ $errors->has('docket_number') ? 'is-invalid' : '' }}" type="text" name="docket_number" id="docket_number" value="{{ old('docket_number', $caseLaw->docket_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('court') ? 'is-invalid' : '' }}" type="text" name="court" id="court" value="{{ old('court', $caseLaw->court) }}" required>
                @if($errors->has('court'))
                    <div class="invalid-feedback">
                        {{ $errors->first('court') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('case') ? 'is-invalid' : '' }}" type="text" name="case" id="case" value="{{ old('case', $caseLaw->case) }}" required>
                @if($errors->has('case'))
                    <div class="invalid-feedback">
                        {{ $errors->first('case') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('decided') ? 'is-invalid' : '' }}" type="text" name="decided" id="decided" value="{{ old('decided', $caseLaw->decided) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('case_narrative') ? 'is-invalid' : '' }}" name="case_narrative" id="case_narrative" required>{{ old('case_narrative', $caseLaw->case_narrative) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('judge') ? 'is-invalid' : '' }}" type="text" name="judge" id="judge" value="{{ old('judge', $caseLaw->judge) }}" required>
                @if($errors->has('judge'))
                    <div class="invalid-feedback">
                        {{ $errors->first('judge') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('added_by') ? 'is-invalid' : '' }}" type="text" name="added_by" id="added_by" value="{{ old('added_by', $caseLaw->added_by) }}" required>
