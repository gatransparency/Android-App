...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.agenciesOffice.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.agencies-offices.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agency_name') ? 'is-invalid' : '' }}" type="text" name="agency_name" id="agency_name" value="{{ old('agency_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_address_additional') ? 'is-invalid' : '' }}" type="text" name="street_address_additional" id="street_address_additional" value="{{ old('street_address_additional', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agency_email') ? 'is-invalid' : '' }}" type="email" name="agency_email" id="agency_email" value="{{ old('agency_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agency_rating') ? 'is-invalid' : '' }}" type="text" name="agency_rating" id="agency_rating" value="{{ old('agency_rating', '') }}">
